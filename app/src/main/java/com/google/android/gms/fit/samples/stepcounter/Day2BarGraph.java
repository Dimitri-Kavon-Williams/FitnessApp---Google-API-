...
import com.google.android.gms.fit.samples.stepcounter.databinding.Day2barchartBinding;
import java.util.ArrayList;

public class Day2BarGraph extends AppCompatActivity {

    //Data Binding
    private Day2barchartBinding day2barchartBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        day2barchartBinding = DataBindingUtil.setContentView(this, R.layout.day2barchart);

        // Erstelle die Barchart bzw. Graphen
        barChart = day2barchartBinding.day2Barchart;

        // Besorge die allgemeinen Daten die für die täglich neue Darstellung des Graphen angezeigt werden soll.
        Bundle extras = getIntent().getExtras();

        stepValue = extras.getInt("stepsDay2");
