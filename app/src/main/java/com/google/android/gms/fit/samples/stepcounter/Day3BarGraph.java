...
import com.google.android.gms.fit.samples.stepcounter.databinding.Day3barchartBinding;

import java.util.ArrayList;

public class Day3BarGraph extends AppCompatActivity {

    //Data Binding
    private Day3barchartBinding day3barchartBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        day3barchartBinding = DataBindingUtil.setContentView(this, R.layout.day3barchart);

        // Erstelle die Barchart bzw. Graphen
        barChart = day3barchartBinding.day3Barchart;

        // Besorge die allgemeinen Daten die für die täglich neue Darstellung des Graphen angezeigt werden soll.
        Bundle extras = getIntent().getExtras();

        stepValue = extras.getInt("stepsDay3");
