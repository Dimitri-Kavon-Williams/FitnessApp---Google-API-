...
public class Day5BarGraph extends AppCompatActivity {

    //Data Binding
    private Day5barchartBinding day5barchartBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        day5barchartBinding = DataBindingUtil.setContentView(this, R.layout.day5barchart);

        // Erstelle die Barchart bzw. Graphen
        barChart = day5barchartBinding.day5Barchart;

        // Besorge die allgemeinen Daten die für die täglich neue Darstellung des Graphen angezeigt werden soll.
        Bundle extras = getIntent().getExtras();

        stepValue = extras.getInt("stepsDay5");
