...
import com.google.android.gms.fit.samples.stepcounter.databinding.Day5barchartBinding;
import com.google.android.gms.fit.samples.stepcounter.databinding.Day6barchartBinding;

import java.util.ArrayList;

public class Day6BarGraph extends AppCompatActivity {

    //Data Binding
    private Day6barchartBinding day6barchartBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        day6barchartBinding = DataBindingUtil.setContentView(this, R.layout.day6barchart);

        // Erstelle die Barchart bzw. Graphen
        barChart = day6barchartBinding.day6Barchart;

        // Besorge die allgemeinen Daten die für die täglich neue Darstellung des Graphen angezeigt werden soll.
        Bundle extras = getIntent().getExtras();

        stepValue = extras.getInt("stepsDay6");
