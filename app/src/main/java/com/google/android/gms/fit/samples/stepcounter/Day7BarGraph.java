...
import com.google.android.gms.fit.samples.stepcounter.databinding.Day7barchartBinding;

import java.util.ArrayList;

public class Day7BarGraph extends AppCompatActivity {

    //Data Binding
    private Day7barchartBinding day7barchartBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        day7barchartBinding = DataBindingUtil.setContentView(this, R.layout.day7barchart);

        // Erstelle die Barchart bzw. Graphen
        barChart = day7barchartBinding.day7Barchart;

        // Besorge die allgemeinen Daten die für die täglich neue Darstellung des Graphen angezeigt werden soll.
        Bundle extras = getIntent().getExtras();

        stepValue = extras.getInt("stepsDay7");
